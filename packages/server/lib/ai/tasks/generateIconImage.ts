const genereateIconImagePrompt = `# Icon Generation Base Prompt
...
## Avoid
Realism, thin lines, dim colors, mascots, text, solid backgrounds, too much detail, cultural/religious symbols, inappropriate content.
...
export default { prompt: genereateIconImagePrompt };

...
interface HowItWorksStep4Props {
	textTranslateY: number;
	distanceFromCenter: number;
}

export const HowItWorksStep4 = forwardRef<HTMLDivElement, HowItWorksStep4Props>(
	function HowItWorksStep4({ textTranslateY, distanceFromCenter }, ref) {
		const textColor = "#b5c995";
		...
		return (
			...
			>
				<div className="sticky top-0 h-screen flex flex-col items-center justify-end px-6 md:px-12 overflow-visible pb-12 md:pb-16">
					...
					>
						<FlowText
							text="Learn & earn — Quizzes, streaks, and rewards"
							textColor={textColor}
